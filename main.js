...
const icons = {
  ...
  decrementQty: `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 24 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-minus"><path d="M5 12h14"/></svg>`,
  incrementQty: `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 24 18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-plus"><path d="M5 12h14"/><path d="M12 5v14"/></svg>`,
    ...
    container.innerHTML += `
            <div class='dessert'> 
                ...
                <div class='btn_wrapper'>
                  <button class='dessert_btn' onclick=incrementQty(event)>  </button>
                  ${icons.addToCart} 
                  <p>Add to Cart</p> 
                </div>
